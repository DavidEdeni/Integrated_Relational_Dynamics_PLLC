      ...
      <Container maxWidth="md">
        ...
        <Paper elevation={0} sx={{ p: { xs: 4, md: 8 }, border: '1px solid #E0D8D0', bgcolor: 'background.paper' }}>
          ...
          <Section title="How therapy works here">
            ...
            <Typography variant="body2" sx={{ mt: 2, p: 2, bgcolor: '#F9F7F5', borderLeft: '3px solid #6D5D50' }}>
          ...
          <Section title="Therapy interest (email) — October 2026 start">
            ...
            <Typography variant="body2" align="center" color="text.secondary" sx={{ mt: 2, fontStyle: 'italic' }}>
